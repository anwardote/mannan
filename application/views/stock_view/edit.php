    ...
    <div class="span12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">
                ...
                <?php echo form_open('dashboard/stock/edit/' . $stock['id'], array("class" => "form-horizontal")); ?>

                <div class="form-group">
                    <label for="title" class="col-md-4 control-label">Title</label>
                    <div class="col-md-8 controls with-tooltip">
                        <input type="text" name="title" value="<?php echo ($this->input->post('title') ? $this->input->post('title') : $stock['title']); ?>" class="form-control span6 input-tooltip" id="title" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 controls with-tooltip">
                        <textarea name="description" class="tinymce form-control span6 input-tooltip"><?php echo ($this->input->post('description') ? $this->input->post('description') : $stock['description']); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 controls with-tooltip">
                        <select name="is_hidden" class="form-control span6 input-tooltip">
                            <?php
                            $Cstatus = ($this->input->post('is_hidden') ? $this->input->post('is_hidden') : $stock['is_hidden']);
                            if ($Cstatus == 0) {
                                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 controls with-tooltip">
                        <input type="text" name="remark" value="<?php echo ($this->input->post('remark') ? $this->input->post('remark') : $stock['remark']); ?>" class="form-control span6 input-tooltip" id="remark" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 controls with-tooltip">
                        ...
                        $timeStamp = ($this->input->post('created') ? $this->input->post('created') : $stock['created']);
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 controls with-tooltip">
                        <input type="text" value="<?php
                        $datetime = ($this->input->post('updated') ? $this->input->post('updated') : $stock['updated']);
