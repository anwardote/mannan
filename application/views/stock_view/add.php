    ...
    <div class="span12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">	
                <div class="pull-right"><a class="btn btn-info" href="<?php echo site_url('dashboard/stock/index'); ?>">List</a></div>

                <?php echo form_open('dashboard/stock/add', array("class" => "form-horizontal")); ?>
