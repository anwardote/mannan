            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="bank_capital_form_edit" style="margin:12px; display: none" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 controls with-tooltip">
                            <input type="text" name="amount" value="<?php echo $this->input->post('amount'); ?>" class="form-control span6 input-tooltip" id="amount" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 controls with-tooltip">
                            <input type="text" name="entry_date" value="" class="form-control  span6 input-tooltip datepicker" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 controls with-tooltip">
                            <textarea name="comments" class="form-control  span6 input-tooltip" id="comments"><?php echo $this->input->post('comments'); ?></textarea>
