    ...
    <div class="span12">
        <div class="box dark">
            <header>
                ...
                <h5>Pictures Categories Entry</h5>
                <!-- .toolbar -->
                <div class="toolbar">
                    <ul class="nav">
            ...
            <div id="div-1" class="accordion-body collapse in body">	
                <div class="pull-right"><a class="btn btn-info" href="<?php echo site_url('dashboard/pcategory/index'); ?>">List</a></div>

                <?php echo form_open_multipart('dashboard/pcategory/add', array("class" => "form-horizontal")); ?>
