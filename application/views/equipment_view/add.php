    ...
    <div class="span12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">	
                <div class="pull-right"><a class="btn btn-info" href="<?php echo site_url('dashboard/equipment/index'); ?>">List</a></div>

                <?php echo form_open('dashboard/equipment/add', array("class" => "form-horizontal")); ?>
