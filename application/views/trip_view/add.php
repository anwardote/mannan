    ...
    <div class="span12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">	
                <div class="pull-right"><a class="btn btn-info" href="<?php echo site_url('dashboard/trip/index'); ?>">List</a></div>

                <?php echo form_open_multipart('dashboard/trip/add', array("class" => "form-horizontal")); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 controls with-tooltip">
                        <select name="tcategorie_id" class="form-control span6 input-tooltip">
                            ...
                            <?php
                            $Cstatus = ($this->input->post('tcategorie_id') ? $this->input->post('tcategorie_id') : "");
                            echo $Cstatus;
                            //exit();
                            print_r($Cstatus);
                            foreach ($all_tcategories as $tcategory) {
                                if ($Cstatus == $tcategory['id']) {
                                    echo '<option value="' . $tcategory['id'] . '" selected="selected">' . $tcategory['title'] . '</option>';
                                } else {
                                    echo '<option value="' . $tcategory['id'] . '">' . $tcategory['title'] . '</option>';
                                }
                            }
                            ?>
                        </select>
